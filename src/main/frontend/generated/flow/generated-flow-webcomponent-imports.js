...
injectGlobalWebcomponentCss($cssFromFile_87.toString());
...
import 'react-router';
import 'react';
injectGlobalWebcomponentCss($cssFromFile_90.toString());
injectGlobalWebcomponentCss($cssFromFile_91.toString());
injectGlobalWebcomponentCss($cssFromFile_92.toString());
injectGlobalWebcomponentCss($cssFromFile_93.toString());
injectGlobalWebcomponentCss($cssFromFile_94.toString());
injectGlobalWebcomponentCss($cssFromFile_95.toString());
